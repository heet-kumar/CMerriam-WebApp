  ...
  return (
    <div className="detailRow">
      ...
      <div className="contacts">
         ...
         <div className="icon">
         <a
             href={`https://api.whatsapp.com/send?phone=${props.number}&text=Hello%2c%20I%20want%20to%20know%20about%20the%20${props.resource}%20.I%20need%20them..&source=&data=&app_absent=`}
            target='blank'
